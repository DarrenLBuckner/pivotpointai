      ...
      <main className="w-full max-w-3xl flex flex-col gap-8 sm:gap-10 items-center relative z-10 text-[#1a237e] px-4 sm:px-6 lg:px-8">
        ...
        <section className="w-full bg-white/80 rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 border border-[#d3e3fd] mt-6 sm:mt-8">
          ...
          <div className="prose prose-sm sm:prose-lg text-[#1a237e] mx-auto space-y-4 sm:space-y-6">
            ...
            <p>Founded by <strong><a href="https://www.darrenlbuckner.com" target="_blank" rel="noopener noreferrer">Darren L. Buckner</a></strong> and <strong>Rochelle Pydana Buckner</strong>, our leadership blends African American innovation with deep Caribbean roots. Rochelle was born and raised in Guyana, educated at the University of Guyana and Michigan State University in the U.S., and brings a strong STEM background in science and technology along with successful companies like Pydana Collection. Darren, a U.S. Army veteran and African American entrepreneur who attended the historic HBCU Talladega College, brings decades of business-building experience and a commitment to economic empowerment in underrepresented communities. He is also the founder of Portal HomeHub and Guyana HomeHub, and was <a href="https://blacknews.com/news/darren-buckner-black-army-veteran-taught-himself-how-to-code-selected-national-speaker-126th-national-business-league-conference/" target="_blank" rel="noopener noreferrer">selected as a National Speaker at the 126th National Business League Conference</a> in 2026.</p>
